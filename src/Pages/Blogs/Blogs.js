...
const Blogs = () => {
    return (
        <div className=' shadow qna py-5 px-5 lg:px-20 flex flex-col gap-10'>
            ...
            <div>
                <h1 className='text-2xl font bold text-primary py-3'>How will you improve the performance of a React Application?
                </h1>
                <p className='w-3/4'>
            ...
            <div>
                <h1 className='text-2xl font bold text-primary py-3'>What are the different ways to manage a state in a React application?
            ...
            <div>
                <h1 className='text-2xl font bold text-primary py-3'>What is a unit test? Why should write unit tests?
                </h1>
                <p className='w-3/4'>
            ...
            <div>
                <h1 className='text-2xl font bold text-primary py-3'>How does prototypical inheritance work?
                </h1>
                <p className='w-3/4'>
            ...
            <div>
                <h1 className='text-2xl font bold text-primary py-3'>Why you do not set the state directly in React?
                </h1>
                <p className='w-3/4'>
